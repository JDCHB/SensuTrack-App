...
<div class="form-wrapper">
    <div class="form-title">REGISTRO DE ROLES</div>
    <form on:submit|preventDefault={RegisterRol} class="vibrant-form">
        <input
            class="vibrant-input"
            bind:value={v_nombre}
        ...
        <button class="vibrant-button">REGISTRAR ROL</button>
    </form>
</div>
...
<div id="MostrarRoles">
    <div class="roles-container">
        <h2 class="roles-title">
            <i class="bi bi-diagram-3"></i> Lista de Roles
        </h2>
...
>
    <div class="mobile-modal-card">
        ...
        <div class="mobile-modal-body">
            ...
            <!-- Módulos -->
            <!-- Módulos - Versión accesible corregida -->
            <div class="mobile-form-group">
                <fieldset>
                    <legend id="modules-legend"
                        ><b>Seleccione los módulos:</b></legend
                    >
                    <div
                        class="mobile-checkbox-grid"
                        role="group"
                        aria-labelledby="modules-legend"
                    >
